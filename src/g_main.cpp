...
cvar_t* g_no_bfg;
cvar_t* g_no_chainfist;
cvar_t* g_no_chaingun;
cvar_t* g_no_disruptor;
cvar_t* g_no_etf_rifle;
cvar_t* g_no_glauncher;
cvar_t* g_no_hyperblaster;
cvar_t* g_no_ionripper;
cvar_t* g_no_machinegun;
cvar_t* g_no_phalanx;
cvar_t* g_no_plasmabeam;
cvar_t* g_no_proxlauncher;
cvar_t* g_no_railgun;
cvar_t* g_no_rlauncher;
cvar_t* g_no_shotgun;
cvar_t* g_no_sshotgun;
cvar_t* g_no_powerups;
cvar_t* g_no_quad;
cvar_t* g_no_dualfire;
cvar_t* g_no_invulnerability;
cvar_t* g_no_invisibility;
...
void InitGame()
{
	...
	g_no_bfg = gi.cvar("g_no_bfg", "0", CVAR_LATCH);
	g_no_chainfist = gi.cvar("g_no_chainfist", "0", CVAR_LATCH);
	g_no_chaingun = gi.cvar("g_no_chaingun", "0", CVAR_LATCH);
	g_no_disruptor = gi.cvar("g_no_disruptor", "0", CVAR_LATCH);
	g_no_etf_rifle = gi.cvar("g_no_etf_rifle", "0", CVAR_LATCH);
	g_no_glauncher = gi.cvar("g_no_glauncher", "0", CVAR_LATCH);
	g_no_hyperblaster = gi.cvar("g_no_hyperblaster", "0", CVAR_LATCH);
	g_no_ionripper = gi.cvar("g_no_ionripper", "0", CVAR_LATCH);
	g_no_machinegun = gi.cvar("g_no_machinegun", "0", CVAR_LATCH);
	g_no_phalanx = gi.cvar("g_no_phalanx", "0", CVAR_LATCH);
	g_no_plasmabeam = gi.cvar("g_no_plasmabeam", "0", CVAR_LATCH);
	g_no_proxlauncher = gi.cvar("g_no_proxlauncher", "0", CVAR_LATCH);
	g_no_railgun = gi.cvar("g_no_railgun", "0", CVAR_LATCH);
	g_no_rlauncher = gi.cvar("g_no_rlauncher", "0", CVAR_LATCH);
	g_no_shotgun = gi.cvar("g_no_shotgun", "0", CVAR_LATCH);
	g_no_sshotgun = gi.cvar("g_no_sshotgun", "0", CVAR_LATCH);
	g_no_powerups = gi.cvar("g_no_powerups", "0", CVAR_LATCH);
	g_no_quad = gi.cvar("g_no_quad", "0", CVAR_LATCH);
	g_no_dualfire = gi.cvar("g_no_dualfire", "0", CVAR_LATCH);
	g_no_invulnerability = gi.cvar("g_no_invulnerability", "0", CVAR_LATCH);
	g_no_invisibility = gi.cvar("g_no_invisibility", "0", CVAR_LATCH);
